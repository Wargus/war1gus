function RunEndScenarioMenu()
  ...
  local b = menu:addFullButton("~!Restart Scenario", "r", 25, 40 + (36 * 0),
    function() RunRestartConfirmMenu() end)
  if (IsNetworkGame()) then
    b:setEnabled(false)
  end
  menu:addFullButton("~!Surrender", "s", 25, 40 + (36 * 1),
    function() RunSurrenderConfirmMenu() end)
  menu:addFullButton("~!Quit to Menu", "q", 25, 40 + (36 * 2),
    function() RunQuitToMenuConfirmMenu() end)
  menu:addFullButton("E~!xit Program", "x", 25, 40 + (36 * 3),
...
function RunRestartConfirmMenu()
  ...
  menu:addFullButton("~!Restart Scenario", "r", 25, 11 + (24 * 3) + 29,
...
function RunSurrenderConfirmMenu()
  ...
  menu:addFullButton("~!Surrender", "s", 25, 11 + (24 * 3) + 29,
...
function RunQuitToMenuConfirmMenu()
  ...
  menu:addFullButton("~!Quit to Menu", "q", 25, 11 + (24 * 3) + 29,
...
function RunExitConfirmMenu()
  ...
  menu:addFullButton("E~!xit Program", "x", 25, 11 + (24 * 3) + 29,
    function() Exit(0) end)
  menu:addFullButton("Cancel (~<Esc~>)", "escape", 25, 228,
    function() menu:stop() end)
