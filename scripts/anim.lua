...
local function BuildAttackAnimation(frames)
	...
	for i = 1, #frames do
		...
		-- attacks are all about equally fast/slow
		res[1 + #res] = "wait " .. (5 * 5 / #frames)
	end
	res[1 + #res] = "unbreakable end"
	res[1 + #res] = "frame 0"
	res[1 + #res] = "wait 1"
...
DefineAnimations("animations-water-elemental", BuildAnimations(frameNumbers_5_3_5_3))

DefineAnimations("animations-fire-elemental", BuildAnimations(frameNumbers_5_5_4_3))
...
DefineAnimations("animations-scorpion", BuildAnimations(frameNumbers_5_5_5_5))
...
DefineAnimations("animations-spearman", BuildAnimations(frameNumbers_5_5_2_3))
...
DefineAnimations("animations-warlock", BuildAnimations(frameNumbers_5_5_4_4))

DefineAnimations("animations-medivh", BuildAnimations(frameNumbers_5_5_5_3))
