...
local units = {
   ...
   {Names = {neutral = "Water elemental"},
    ...
    organic = false},
   {Names = {orc = "Grizelda"},
    Image = {"file", "neutral/units/grizelda,garona.png", "size", {64 / 2, 64 / 2}},
    HitPoints = 30,
    Armor = 0,
    BasicDamage = 0,
    Coward = true},
...
local knight_raider_spec = {
   ...
   Image = {orc = {"file", "orc/units/raider.png", "size", {96 / 2, 96 / 2}},
            human = {"file", "human/units/knight.png", "size", {64 / 2, 64 / 2}}},
...
local dead_bodies = { Name = "Dead Body",
  Image = {"file", "neutral/units/dead_bodies.png", "size", {64 / 2, 64 / 2}},
