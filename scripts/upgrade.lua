...
local upgrades = {
   {orc = {"axe1", {"grunt", "raider", "raider1", "raider2"}},
    human = {"sword1", {"footman", "knight", "knight1", "knight2"}},
    cost = {   120,   750,     0,     0,     0,     0,     0},
    modifier = {"PiercingDamage", 2}},
   {orc = {"axe2", {"grunt", "raider", "raider1", "raider2"}},
    human = {"sword2", {"footman", "knight", "knight1", "knight2"}},
   ...
   {orc = {"orc-shield1", {"grunt", "raider", "raider1", "raider2"}},
    human = {"human-shield1", {"footman", "knight", "knight1", "knight2"}},
    cost = {   120,   750,     0,     0,     0,     0,     0},
    modifier = {"Armor", 2}},
   {orc = {"orc-shield2", {"grunt", "raider", "raider1", "raider2"}},
    human = {"human-shield2", {"footman", "knight", "knight1", "knight2"}},
    cost = {   120,   1500,     0,     0,     0,     0,     0},
    modifier = {"Armor", 2},
