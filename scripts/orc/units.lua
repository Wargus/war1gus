...
DefineUnitType("unit-orc-catapult", { Name = "Catapult",
  ...
  Animations = "animations-todo", Icon = "icon-orc-catapult",
  Costs = {"time", 70},
...
DefineUnitType("unit-grunt", { Name = "Grunt",
  ...
  Animations = "animations-todo", Icon = "icon-grunt",
  Costs = {"time", 70},
  NeutralMinimapColor = {192, 0, 0},
  HitPoints = 60,
  DrawLevel = 60,
...
DefineUnitType("unit-lothar", { Name = "Lothar",
  ...
  Animations = "animations-todo", Icon = "icon-lothar",
  Costs = {"time", 70},
  NeutralMinimapColor = {192, 0, 0},
  HitPoints = 60,
  DrawLevel = 60,
...
DefineUnitType("unit-necrolyte", { Name = "Necrolyte",
  ...
  Animations = "animations-todo", Icon = "icon-necrolyte",
  Costs = {"time", 70},
  NeutralMinimapColor = {192, 0, 0},
  HitPoints = 60,
  DrawLevel = 60,
...
DefineUnitType("unit-peon", { Name = "Peon",
  ...
  Animations = "animations-todo", Icon = "icon-peon",
  Costs = {"time", 70},
  NeutralMinimapColor = {192, 0, 0},
  HitPoints = 60,
  DrawLevel = 60,
...
DefineUnitType("unit-raider", { Name = "Raider",
  ...
  Animations = "animations-todo", Icon = "icon-raider",
  Costs = {"time", 70},
  NeutralMinimapColor = {192, 0, 0},
  HitPoints = 60,
  DrawLevel = 60,
...
DefineUnitType("unit-spearman", { Name = "Spearman",
  ...
  Animations = "animations-todo", Icon = "icon-spearman",
  Costs = {"time", 70},
  NeutralMinimapColor = {192, 0, 0},
  HitPoints = 60,
  DrawLevel = 60,
...
DefineUnitType("unit-warlock", { Name = "Warlock",
  ...
  Animations = "animations-todo", Icon = "icon-warlock",
  Costs = {"time", 70},
  NeutralMinimapColor = {192, 0, 0},
  HitPoints = 60,
  DrawLevel = 60,
