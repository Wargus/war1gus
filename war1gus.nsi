...
!define COPYRIGHT "(C) 1998-2016 by The Stratagus Project"
...
LangString INSTALLER_RUNNING ${LANG_RUSSIAN} "”становщик ${NAME} уже запущен"
...
LangString REMOVEPREVIOUS ${LANG_RUSSIAN} "”дал€ютс€ файлы из предыдущей установки"
LangString REMOVECONFIGURATION ${LANG_ENGLISH} "Removing configuration and data files:"
LangString REMOVECONFIGURATION ${LANG_RUSSIAN} "”дал€ютс€ данные и файлы конфигураций:"
LangString DESC_REMOVEEXE ${LANG_ENGLISH} "Remove ${NAME} binary executables"
LangString DESC_REMOVEEXE ${LANG_RUSSIAN} "”дал€ютс€ исполн€емые файлы ${NAME}"
...
LangString DESC_REMOVECONF ${LANG_RUSSIAN} "”далить все прочие файлы и директории в установочной папке ${NAME}, созданные пользователем ${NAME}"

LangString STR_VERSION ${LANG_ENGLISH} "version"
LangString STR_VERSION ${LANG_RUSSIAN} "верси€"

!ifdef x86_64
LangString x86_64_ONLY ${LANG_ENGLISH} "This version is for 64 bits computers only"
LangString x86_64_ONLY ${LANG_RUSSIAN} "Ёта верси€ предназначена дл€ 64-битных систем"
!endif
